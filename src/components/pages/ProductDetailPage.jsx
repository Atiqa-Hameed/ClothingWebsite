...
const ProductDetailPage = ({ products }) => {
  ...
  useEffect(() => {
    // Fetch the product based on the ID (simulate fetching from global state or API)
    const fetchedProduct = products.find((prod) => prod.id === parseInt(id));

    if (fetchedProduct) {
      setProduct(fetchedProduct);
    }
  }, [id, products]); // Re-run effect when ID changes or products update
  ...
  // Show a loader or "Product not found" message if the product is not available yet
  if (!product) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-[5fr,3fr] gap-8">
          ...
          <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6">
            ...
            <div className="flex-1">
              <img
                src={selectedImage || product.imageUrls[0]} // Use the selected image or fallback to the first image
                alt={product.title}
          ...
          <div className="col-span-1 pl-4">
            ...
            <h2 className="text-md font-medium text-gray-600 mt-2">Brand: Name</h2>
            <p className="text-gray-500 mt-1 text-md font-sans">Sold by: Seller's Name</p>
            {/* Rating */}
            ...
            <div className="flex items-center mt-2">
              ...
              <span className="text-gray-500 line-through ml-4">Rs. {product.originalPrice}</span>
